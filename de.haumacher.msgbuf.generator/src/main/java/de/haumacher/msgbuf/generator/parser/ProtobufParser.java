...
Token importPath;
      importPath = jj_consume_token(STRING);
...
{if ("" != null) return result;}
  ...
  final public void optionAssignment(WithOptions part) throws ParseException {Option option;
  Token t;
...
part.getOptions().put(t.image, Flag.create().setValue(true));
  ...
  final public Option value() throws ParseException {Option result;
  Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case STRING:{
...
{if ("" != null) return result;}
  ...
  final public Definition definition() throws ParseException {String comment;
  Definition result;
  WithOptions options;
...
result.setComment(comment);
  ...
  final public DefinitionBase memberDefinition() throws ParseException {String comment;
...
result.setComment(comment);
  ...
  final public EnumDef enumeration() throws ParseException {EnumDef result = EnumDef.create();
  String name;
  Constant constant;
  Token d;
...
{if ("" != null) return result;}
  ...
  final public Constant constant() throws ParseException {Constant result = Constant.create();
  String name;
  Token index;
...
{if ("" != null) return result;}
  ...
  final public MessageDef message() throws ParseException {MessageDef result = MessageDef.create();
  String name;
...
{if ("" != null) return result;}
  ...
  final public Field field() throws ParseException {Field result = Field.create();
  Type type;
  String name;
  Token def;
  Token comment;
...
result.setName(name);
    ...
    case 37:{
      ...
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case NUMBER:{
        def = jj_consume_token(NUMBER);
        break;
        }
      case TRUE:{
        def = jj_consume_token(TRUE);
        break;
        }
      case FALSE:{
        def = jj_consume_token(FALSE);
        break;
        }
      case STRING:{
        def = jj_consume_token(STRING);
        break;
        }
      case NULL:{
        def = jj_consume_token(NULL);
        break;
        }
      default:
        jj_la1[19] = jj_gen;
...
{if ("" != null) return result;}
  ...
  final public WithOptions javaAnnotations() throws ParseException {WithOptions result;
    result = javaAnnotationsFor(null);
{if ("" != null) return result;}
    throw new Error("Missing return statement in function");
}

  final public WithOptions javaAnnotationsFor(WithOptions result) throws ParseException {Token optionName;
  Option option;
    label_7:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return result;}
  ...
  final public Type type() throws ParseException {Type result;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INT_TYPE:
    case LONG_TYPE:
    case BOOLEAN_TYPE:
...
{if ("" != null) return result;}
  ...
  final public PrimitiveType primitiveType() throws ParseException {Token t;
...
result = PrimitiveType.create().setKind(PrimitiveType.Kind.BOOL);
    ...
    case JSON_TYPE:{
      t = jj_consume_token(JSON_TYPE);
result = PrimitiveType.create().setKind(PrimitiveType.Kind.JSON);
      break;
      }
    default:
      jj_la1[32] = jj_gen;
...
{if ("" != null) return result;}
  ...
  final public CustomType customType() throws ParseException {QName name;
    name = qName();
{if ("" != null) return CustomType.create().setName(name);}
    throw new Error("Missing return statement in function");
}

  final public MapType map() throws ParseException {Type keyType;
  Type valueType;
    ...
    valueType = type();
    jj_consume_token(48);
{if ("" != null) return MapType.create().setKeyType(keyType).setValueType(valueType);}
    throw new Error("Missing return statement in function");
}

  final public QName qName() throws ParseException {QName result = QName.create();
  String name;
    name = name();
result.addName(name);
    label_11:
...
{if ("" != null) return result;}
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x400,0x100,0x200,0x20000,0x81800,0x0,0x1800000,0x81800,0x7c69b800,0x20000,0x20700000,0x20700000,0x0,0x80000,0x40000,0x7c7bf800,0x7c7bf800,0x10000,0x8000,0x3800000,0x0,0x0,0x0,0x0,0x0,0x0,0x400000,0x200000,0x0,0x0,0x7c602000,0x7c602000,0x7c000000,0x0,0x20600000,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x200,0x20,0x3,0x0,0x14,0x0,0x214,0x214,0x20,0x0,0x0,0x214,0x214,0x0,0x0,0x3,0x20,0x200,0x400,0x2000,0x1000,0x2000,0x1,0x0,0x3,0x20,0x14,0x14,0x0,0x20000,0x14,};
	}
