...
public class SearchRequest_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements test.comments.data.SearchRequest {
	 ...
	 *
	 * @see test.comments.data.SearchRequest#create()
	 */
	...
	@Override
	public test.comments.data.SearchRequest setQuery(String value) {
	...
	@Override
	public test.comments.data.SearchRequest setPageNumber(int value) {
	...
	@Override
	public test.comments.data.SearchRequest setResultPerPage(int value) {
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return test.comments.data.SearchRequest.super.get(field);
		}
	}
	...
	/** Helper for creating an object of type {@link test.comments.data.SearchRequest} from a polymorphic composition. */
	public static test.comments.data.SearchRequest readSearchRequest_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.comments.data.impl.SearchRequest_Impl result = new SearchRequest_Impl();
	...
	/** XML element name representing a {@link test.comments.data.SearchRequest} type. */
	...
	/** Creates a new {@link test.comments.data.SearchRequest} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
