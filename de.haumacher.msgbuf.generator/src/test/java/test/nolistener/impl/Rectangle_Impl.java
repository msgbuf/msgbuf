...
public class Rectangle_Impl extends test.nolistener.impl.AtomicShape_Impl implements test.nolistener.Rectangle {
	 ...
	 *
	 * @see test.nolistener.Rectangle#create()
	 */
	...
	@Override
	public test.nolistener.Rectangle setWidth(int value) {
	...
	@Override
	public test.nolistener.Rectangle setHeight(int value) {
	...
	@Override
	public test.nolistener.Rectangle setXCoordinate(int value) {
		internalSetXCoordinate(value);
		return this;
	}

	@Override
	public test.nolistener.Rectangle setYCoordinate(int value) {
	...
	/** Helper for creating an object of type {@link test.nolistener.Rectangle} from a polymorphic composition. */
	public static test.nolistener.Rectangle readRectangle_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.nolistener.impl.Rectangle_Impl result = new Rectangle_Impl();
	...
	/** XML element name representing a {@link test.nolistener.Rectangle} type. */
	...
	/** Creates a new {@link test.nolistener.Rectangle} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
	...
	@Override
	public <R,A,E extends Throwable> R visit(test.nolistener.AtomicShape.Visitor<R,A,E> v, A arg) throws E {
