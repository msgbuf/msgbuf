...
public abstract class Shape_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements test.nolistener.Shape {
	...
	@Override
	public test.nolistener.Shape setXCoordinate(int value) {
	...
	@Override
	public test.nolistener.Shape setYCoordinate(int value) {
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return test.nolistener.Shape.super.get(field);
		}
	}
	...
	/** XML element name representing a {@link test.nolistener.Shape} type. */
	...
	/** Creates a new {@link test.nolistener.Shape} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
