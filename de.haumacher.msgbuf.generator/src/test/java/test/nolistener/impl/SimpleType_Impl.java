...
/**
 * Implementation of {@link test.nolistener.SimpleType}.
 */
public class SimpleType_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements test.nolistener.SimpleType {
	 ...
	 *
	 * @see test.nolistener.SimpleType#create()
	 */
	...
	@Override
	public test.nolistener.SimpleType setStr(String value) {
	...
	@Override
	public test.nolistener.SimpleType setX(int value) {
		internalSetX(value);
		return this;
	}
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return test.nolistener.SimpleType.super.get(field);
		}
	}
	...
	/** Helper for creating an object of type {@link test.nolistener.SimpleType} from a polymorphic composition. */
	public static test.nolistener.SimpleType readSimpleType_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.nolistener.impl.SimpleType_Impl result = new SimpleType_Impl();
	...
	/** XML element name representing a {@link test.nolistener.SimpleType} type. */
	...
	/** Creates a new {@link test.nolistener.SimpleType} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
