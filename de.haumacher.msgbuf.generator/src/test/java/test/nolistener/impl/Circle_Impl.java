...
public class Circle_Impl extends test.nolistener.impl.AtomicShape_Impl implements test.nolistener.Circle {
	 ...
	 *
	 * @see test.nolistener.Circle#create()
	 */
	public Circle_Impl() {
		super();
	}
	...
	@Override
	public test.nolistener.Circle setRadius(int value) {
	...
	@Override
	public test.nolistener.Circle setXCoordinate(int value) {
		internalSetXCoordinate(value);
		return this;
	}

	@Override
	public test.nolistener.Circle setYCoordinate(int value) {
	...
	/** Helper for creating an object of type {@link test.nolistener.Circle} from a polymorphic composition. */
	public static test.nolistener.Circle readCircle_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.nolistener.impl.Circle_Impl result = new Circle_Impl();
	...
	/** XML element name representing a {@link test.nolistener.Circle} type. */
	...
	/** Creates a new {@link test.nolistener.Circle} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
