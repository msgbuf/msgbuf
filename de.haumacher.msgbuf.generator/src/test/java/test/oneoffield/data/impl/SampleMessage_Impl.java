...
public class SampleMessage_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements test.oneoffield.data.SampleMessage {
	 ...
	 *
	 * @see test.oneoffield.data.SampleMessage#create()
	 */
	public SampleMessage_Impl() {
		super();
	}
	...
	/** Helper for creating an object of type {@link test.oneoffield.data.SampleMessage} from a polymorphic composition. */
	public static test.oneoffield.data.SampleMessage readSampleMessage_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.oneoffield.data.impl.SampleMessage_Impl result = new SampleMessage_Impl();
	...
	/** XML element name representing a {@link test.oneoffield.data.SampleMessage} type. */
	...
	/** Creates a new {@link test.oneoffield.data.SampleMessage} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
