...
public abstract class BaseMsg_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements test.underscorename.BaseMsg {
	...
	/** XML element name representing a {@link test.underscorename.BaseMsg} type. */
	...
	/** Creates a new {@link test.underscorename.BaseMsg} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
