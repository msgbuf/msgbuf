...
/**
 * Implementation of {@link test.novisit.Shape}.
 */
public abstract class Shape_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements test.novisit.Shape {
	...
	@Override
	public test.novisit.Shape setXCoordinate(int value) {
	...
	@Override
	public test.novisit.Shape setYCoordinate(int value) {
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return test.novisit.Shape.super.get(field);
		}
	}
	...
	/** XML element name representing a {@link test.novisit.Shape} type. */
	...
	/** Creates a new {@link test.novisit.Shape} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
