...
public class Rectangle_Impl extends test.novisitexceptions.impl.AtomicShape_Impl implements test.novisitexceptions.Rectangle {
	 ...
	 *
	 * @see test.novisitexceptions.Rectangle#create()
	 */
	...
	@Override
	public test.novisitexceptions.Rectangle setWidth(int value) {
	...
	@Override
	public test.novisitexceptions.Rectangle setHeight(int value) {
	...
	@Override
	public test.novisitexceptions.Rectangle setXCoordinate(int value) {
		internalSetXCoordinate(value);
		return this;
	}

	@Override
	public test.novisitexceptions.Rectangle setYCoordinate(int value) {
	...
	/** Helper for creating an object of type {@link test.novisitexceptions.Rectangle} from a polymorphic composition. */
	public static test.novisitexceptions.Rectangle readRectangle_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.novisitexceptions.impl.Rectangle_Impl result = new Rectangle_Impl();
	...
	/** XML element name representing a {@link test.novisitexceptions.Rectangle} type. */
	...
	/** Creates a new {@link test.novisitexceptions.Rectangle} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
