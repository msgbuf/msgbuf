...
public abstract class Shape_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements test.novisitexceptions.Shape {
	...
	@Override
	public test.novisitexceptions.Shape setXCoordinate(int value) {
	...
	@Override
	public test.novisitexceptions.Shape setYCoordinate(int value) {
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return test.novisitexceptions.Shape.super.get(field);
		}
	}
	...
	/** XML element name representing a {@link test.novisitexceptions.Shape} type. */
	...
	/** Creates a new {@link test.novisitexceptions.Shape} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
