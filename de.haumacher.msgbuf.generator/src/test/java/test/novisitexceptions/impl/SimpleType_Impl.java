...
/**
 * Implementation of {@link test.novisitexceptions.SimpleType}.
 */
public class SimpleType_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements test.novisitexceptions.SimpleType {
	 ...
	 *
	 * @see test.novisitexceptions.SimpleType#create()
	 */
	...
	@Override
	public test.novisitexceptions.SimpleType setStr(String value) {
	...
	@Override
	public test.novisitexceptions.SimpleType setX(int value) {
		internalSetX(value);
		return this;
	}
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return test.novisitexceptions.SimpleType.super.get(field);
		}
	}
	...
	/** Helper for creating an object of type {@link test.novisitexceptions.SimpleType} from a polymorphic composition. */
	public static test.novisitexceptions.SimpleType readSimpleType_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.novisitexceptions.impl.SimpleType_Impl result = new SimpleType_Impl();
	...
	/** XML element name representing a {@link test.novisitexceptions.SimpleType} type. */
	...
	/** Creates a new {@link test.novisitexceptions.SimpleType} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
