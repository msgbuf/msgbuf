 ...
 */
class SimpleType_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements SimpleType {
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return SimpleType.super.get(field);
		}
	}
	...
	public static SimpleType readSimpleType_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.novisitexceptions.SimpleType_Impl result = new SimpleType_Impl();
