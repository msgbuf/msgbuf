...
public class SimpleType_Impl implements test.onlyxml.data.SimpleType {
	 ...
	 *
	 * @see test.onlyxml.data.SimpleType#create()
	 */
	...
	@Override
	public test.onlyxml.data.SimpleType setStr(String value) {
	...
	@Override
	public test.onlyxml.data.SimpleType setX(int value) {
		internalSetX(value);
		return this;
	}
	...
	/** XML element name representing a {@link test.onlyxml.data.SimpleType} type. */
	...
	/** Creates a new {@link test.onlyxml.data.SimpleType} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
