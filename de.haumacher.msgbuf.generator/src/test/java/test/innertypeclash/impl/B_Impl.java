...
/**
 * Implementation of {@link test.innertypeclash.B}.
 */
public class B_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements test.innertypeclash.B {
	/**
	 * Implementation of {@link test.innertypeclash.B.C}.
	 */
	public static class C_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements test.innertypeclash.B.C {

		/**
		 * Creates a {@link C_Impl} instance.
		 *
		 * @see test.innertypeclash.B.C#create()
		 */
		public C_Impl() {
			super();
		}
		...
		/** Helper for creating an object of type {@link test.innertypeclash.B.C} from a polymorphic composition. */
		public static test.innertypeclash.B.C readC_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
			test.innertypeclash.impl.B_Impl.C_Impl result = new C_Impl();
		...
		/** XML element name representing a {@link test.innertypeclash.B.C} type. */
		...
		/** Creates a new {@link test.innertypeclash.B.C} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
	...
	private test.innertypeclash.B.C _c = null;

	/**
	 * Creates a {@link B_Impl} instance.
	 *
	 * @see test.innertypeclash.B#create()
	 */
	public B_Impl() {
		super();
	}
	...
	@Override
	public test.innertypeclash.B setAc(test.innertypeclash.A.C value) {
		internalSetAc(value);
		return this;
	}
	...
	@Override
	public test.innertypeclash.B setBc(test.innertypeclash.B.C value) {
		internalSetBc(value);
		return this;
	}
	...
	@Override
	public final test.innertypeclash.B.C getC() {
		return _c;
	}

	@Override
	public test.innertypeclash.B setC(test.innertypeclash.B.C value) {
		internalSetC(value);
		return this;
	}
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return test.innertypeclash.B.super.get(field);
		}
	}
	...
	public void set(String field, Object value) {
		switch (field) {
			...
			case C__PROP: internalSetC((test.innertypeclash.B.C) value); break;
		}
	}
	...
	/** Helper for creating an object of type {@link test.innertypeclash.B} from a polymorphic composition. */
	public static test.innertypeclash.B readB_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.innertypeclash.impl.B_Impl result = new B_Impl();
		result.readContent(in);
		return result;
	}
	...
	/** XML element name representing a {@link test.innertypeclash.B} type. */
	...
	/** Creates a new {@link test.innertypeclash.B} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
	...
	protected void readFieldXmlElement(javax.xml.stream.XMLStreamReader in, String localName) throws javax.xml.stream.XMLStreamException {
		switch (localName) {
			...
			case C__XML_ATTR: {
				setC(test.innertypeclash.impl.B_Impl.C_Impl.readC_XmlContent(in));
				break;
			}
			default: {
				internalSkipUntilMatchingEndElement(in);
