...
class A_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements A {
	static class C_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements C {
		...
		public static C readC_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
			test.innertypeclash.A_Impl.C_Impl result = new C_Impl();
	...
	public static A readA_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.innertypeclash.A_Impl result = new A_Impl();
		result.readContent(in);
		return result;
	}
	...
	protected void readFieldXmlElement(javax.xml.stream.XMLStreamReader in, String localName) throws javax.xml.stream.XMLStreamException {
		switch (localName) {
			...
			case C__XML_ATTR: {
				setC(test.innertypeclash.A_Impl.C_Impl.readC_XmlContent(in));
				break;
			}
			default: {
				internalSkipUntilMatchingEndElement(in);
