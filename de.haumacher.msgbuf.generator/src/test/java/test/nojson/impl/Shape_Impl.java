...
public abstract class Shape_Impl implements test.nojson.Shape {
	...
	@Override
	public test.nojson.Shape setXCoordinate(int value) {
	...
	@Override
	public test.nojson.Shape setYCoordinate(int value) {
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return test.nojson.Shape.super.get(field);
		}
	}
	...
	/** XML element name representing a {@link test.nojson.Shape} type. */
	...
	/** Creates a new {@link test.nojson.Shape} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
