...
public abstract class AtomicShape_Impl extends test.nojson.impl.Shape_Impl implements test.nojson.AtomicShape {
	...
	@Override
	public test.nojson.AtomicShape setXCoordinate(int value) {
		internalSetXCoordinate(value);
		return this;
	}

	@Override
	public test.nojson.AtomicShape setYCoordinate(int value) {
		internalSetYCoordinate(value);
		return this;
	}

	/** XML element name representing a {@link test.nojson.AtomicShape} type. */
	...
	/** Creates a new {@link test.nojson.AtomicShape} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
	...
	@Override
	public final <R,A,E extends Throwable> R visit(test.nojson.Shape.Visitor<R,A,E> v, A arg) throws E {
		return visit((test.nojson.AtomicShape.Visitor<R,A,E>) v, arg);
	}
