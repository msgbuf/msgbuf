...
/**
 * Implementation of {@link test.nojson.Car}.
 */
public class Car_Impl extends test.nojson.impl.Shape_Impl implements test.nojson.Car {

	private test.nojson.Circle _wheel1 = null;

	private test.nojson.Circle _wheel2 = null;

	private test.nojson.Rectangle _body = null;

	/**
	 * Creates a {@link Car_Impl} instance.
	 *
	 * @see test.nojson.Car#create()
	 */
	public Car_Impl() {
		super();
	}
	...
	@Override
	public final test.nojson.Circle getWheel1() {
		return _wheel1;
	}

	@Override
	public test.nojson.Car setWheel1(test.nojson.Circle value) {
	...
	@Override
	public final test.nojson.Circle getWheel2() {
		return _wheel2;
	}

	@Override
	public test.nojson.Car setWheel2(test.nojson.Circle value) {
	...
	@Override
	public final test.nojson.Rectangle getBody() {
		return _body;
	}

	@Override
	public test.nojson.Car setBody(test.nojson.Rectangle value) {
	...
	@Override
	public test.nojson.Car setXCoordinate(int value) {
		internalSetXCoordinate(value);
		return this;
	}

	@Override
	public test.nojson.Car setYCoordinate(int value) {
	...
	public void set(String field, Object value) {
		switch (field) {
			case WHEEL_1__PROP: internalSetWheel1((test.nojson.Circle) value); break;
			case WHEEL_2__PROP: internalSetWheel2((test.nojson.Circle) value); break;
			case BODY__PROP: internalSetBody((test.nojson.Rectangle) value); break;
	...
	/** Helper for creating an object of type {@link test.nojson.Car} from a polymorphic composition. */
	public static test.nojson.Car readCar_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.nojson.impl.Car_Impl result = new Car_Impl();
	...
	/** XML element name representing a {@link test.nojson.Car} type. */
	...
	/** Creates a new {@link test.nojson.Car} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
	...
	protected void readFieldXmlElement(javax.xml.stream.XMLStreamReader in, String localName) throws javax.xml.stream.XMLStreamException {
		switch (localName) {
			case WHEEL_1__XML_ATTR: {
				setWheel1(test.nojson.impl.Circle_Impl.readCircle_XmlContent(in));
				break;
			}
			case WHEEL_2__XML_ATTR: {
				setWheel2(test.nojson.impl.Circle_Impl.readCircle_XmlContent(in));
				break;
			}
			case BODY__XML_ATTR: {
				setBody(test.nojson.impl.Rectangle_Impl.readRectangle_XmlContent(in));
				break;
			}
			default: {
