...
public class SimpleType_Impl implements test.nojson.SimpleType {
	 ...
	 *
	 * @see test.nojson.SimpleType#create()
	 */
	...
	@Override
	public test.nojson.SimpleType setStr(String value) {
	...
	@Override
	public test.nojson.SimpleType setX(int value) {
		internalSetX(value);
		return this;
	}
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return test.nojson.SimpleType.super.get(field);
		}
	}
	...
	/** Helper for creating an object of type {@link test.nojson.SimpleType} from a polymorphic composition. */
	public static test.nojson.SimpleType readSimpleType_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.nojson.impl.SimpleType_Impl result = new SimpleType_Impl();
	...
	/** XML element name representing a {@link test.nojson.SimpleType} type. */
	...
	/** Creates a new {@link test.nojson.SimpleType} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
