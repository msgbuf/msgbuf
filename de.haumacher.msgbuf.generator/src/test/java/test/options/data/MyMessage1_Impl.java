...
class MyMessage1_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements MyMessage1 {

	/**
	 * Creates a {@link MyMessage1_Impl} instance.
	 *
	 * @see MyMessage1#create()
	 */
	protected MyMessage1_Impl() {
		super();
	}
	...
	/** Helper for creating an object of type {@link MyMessage1} from a polymorphic composition. */
	public static MyMessage1 readMyMessage1_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.options.data.MyMessage1_Impl result = new MyMessage1_Impl();
