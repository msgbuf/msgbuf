...
/**
 * Implementation of {@link test.nested.data.Animal}.
 */
public abstract class Animal_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements test.nested.data.Animal {
	...
	@Override
	public test.nested.data.Animal setName(String value) {
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return test.nested.data.Animal.super.get(field);
		}
	}
	...
	/** XML element name representing a {@link test.nested.data.Animal} type. */
	...
	/** Creates a new {@link test.nested.data.Animal} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
	public static Animal_Impl readAnimal_XmlContent(javax.xml.stream.XMLStreamReader in) throws javax.xml.stream.XMLStreamException {
		switch (in.getLocalName()) {
			case test.nested.data.impl.Zoo_Impl.Cat_Impl.CAT__XML_ELEMENT: {
