...
/**
 * Implementation of {@link test.notypekind.SimpleType}.
 */
public class SimpleType_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements test.notypekind.SimpleType {
	 ...
	 *
	 * @see test.notypekind.SimpleType#create()
	 */
	...
	@Override
	public test.notypekind.SimpleType setStr(String value) {
	...
	@Override
	public test.notypekind.SimpleType setX(int value) {
		internalSetX(value);
		return this;
	}
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return test.notypekind.SimpleType.super.get(field);
		}
	}
	...
	/** Helper for creating an object of type {@link test.notypekind.SimpleType} from a polymorphic composition. */
	public static test.notypekind.SimpleType readSimpleType_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.notypekind.impl.SimpleType_Impl result = new SimpleType_Impl();
	...
	/** XML element name representing a {@link test.notypekind.SimpleType} type. */
	...
	/** Creates a new {@link test.notypekind.SimpleType} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
