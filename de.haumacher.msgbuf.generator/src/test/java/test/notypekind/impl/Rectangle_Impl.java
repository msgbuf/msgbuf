...
public class Rectangle_Impl extends test.notypekind.impl.AtomicShape_Impl implements test.notypekind.Rectangle {
	 ...
	 *
	 * @see test.notypekind.Rectangle#create()
	 */
	...
	@Override
	public test.notypekind.Rectangle setWidth(int value) {
	...
	@Override
	public test.notypekind.Rectangle setHeight(int value) {
	...
	@Override
	public test.notypekind.Rectangle setXCoordinate(int value) {
		internalSetXCoordinate(value);
		return this;
	}

	@Override
	public test.notypekind.Rectangle setYCoordinate(int value) {
	...
	/** Helper for creating an object of type {@link test.notypekind.Rectangle} from a polymorphic composition. */
	public static test.notypekind.Rectangle readRectangle_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.notypekind.impl.Rectangle_Impl result = new Rectangle_Impl();
	...
	/** XML element name representing a {@link test.notypekind.Rectangle} type. */
	...
	/** Creates a new {@link test.notypekind.Rectangle} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
	...
	@Override
	public <R,A,E extends Throwable> R visit(test.notypekind.AtomicShape.Visitor<R,A,E> v, A arg) throws E {
