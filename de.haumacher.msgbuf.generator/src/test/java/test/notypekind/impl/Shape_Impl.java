...
/**
 * Implementation of {@link test.notypekind.Shape}.
 */
public abstract class Shape_Impl extends de.haumacher.msgbuf.data.AbstractDataObject implements test.notypekind.Shape {
	...
	@Override
	public test.notypekind.Shape setXCoordinate(int value) {
	...
	@Override
	public test.notypekind.Shape setYCoordinate(int value) {
	...
	public Object get(String field) {
		switch (field) {
			...
			default: return test.notypekind.Shape.super.get(field);
		}
	}
	...
	/** XML element name representing a {@link test.notypekind.Shape} type. */
	...
	/** Creates a new {@link test.notypekind.Shape} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
