...
public class Circle_Impl extends test.notypekind.impl.AtomicShape_Impl implements test.notypekind.Circle {
	 ...
	 *
	 * @see test.notypekind.Circle#create()
	 */
	public Circle_Impl() {
		super();
	}
	...
	@Override
	public test.notypekind.Circle setRadius(int value) {
	...
	@Override
	public test.notypekind.Circle setXCoordinate(int value) {
		internalSetXCoordinate(value);
		return this;
	}

	@Override
	public test.notypekind.Circle setYCoordinate(int value) {
	...
	/** Helper for creating an object of type {@link test.notypekind.Circle} from a polymorphic composition. */
	public static test.notypekind.Circle readCircle_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.notypekind.impl.Circle_Impl result = new Circle_Impl();
	...
	/** XML element name representing a {@link test.notypekind.Circle} type. */
	...
	/** Creates a new {@link test.notypekind.Circle} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
