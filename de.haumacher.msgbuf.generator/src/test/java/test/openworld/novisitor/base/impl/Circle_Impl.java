...
/**
 * Implementation of {@link test.openworld.novisitor.base.Circle}.
 */
public class Circle_Impl extends test.openworld.novisitor.base.impl.Shape_Impl implements test.openworld.novisitor.base.Circle {
	 ...
	 *
	 * @see test.openworld.novisitor.base.Circle#create()
	 */
	public Circle_Impl() {
		super();
	}
	...
	@Override
	public test.openworld.novisitor.base.Circle setRadius(int value) {
	...
	@Override
	public test.openworld.novisitor.base.Circle setName(String value) {
	...
	/** XML element name representing a {@link test.openworld.novisitor.base.Circle} type. */
	...
	/** Creates a new {@link test.openworld.novisitor.base.Circle} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
