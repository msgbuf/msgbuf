...
public class Rectangle_Impl extends test.hierarchy.data.impl.AtomicShape_Impl implements test.hierarchy.data.Rectangle {
	 ...
	 *
	 * @see test.hierarchy.data.Rectangle#create()
	 */
	...
	@Override
	public test.hierarchy.data.Rectangle setWidth(int value) {
	...
	@Override
	public test.hierarchy.data.Rectangle setHeight(int value) {
	...
	@Override
	public test.hierarchy.data.Rectangle setXCoordinate(int value) {
		internalSetXCoordinate(value);
		return this;
	}

	@Override
	public test.hierarchy.data.Rectangle setYCoordinate(int value) {
		internalSetYCoordinate(value);
		return this;
	}

	@Override
	public test.hierarchy.data.Rectangle setColor(test.hierarchy.data.Color value) {
	...
	/** Helper for creating an object of type {@link test.hierarchy.data.Rectangle} from a polymorphic composition. */
	public static test.hierarchy.data.Rectangle readRectangle_Content(de.haumacher.msgbuf.binary.DataReader in) throws java.io.IOException {
		test.hierarchy.data.impl.Rectangle_Impl result = new Rectangle_Impl();
	...
	/** XML element name representing a {@link test.hierarchy.data.Rectangle} type. */
	...
	/** Creates a new {@link test.hierarchy.data.Rectangle} and reads properties from the content (attributes and inner tags) of the currently open element in the given {@link javax.xml.stream.XMLStreamReader}. */
