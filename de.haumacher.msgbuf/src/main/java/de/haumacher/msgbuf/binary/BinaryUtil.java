...
public class BinaryUtil {
	...
	/**
	 * Zig-zag encodes the given <code>int</code> producing a small positive number for inputs with small absolute value.
	 */
	...
	/**
	 * Zig-zag encodes the given <code>long</code> producing a small positive number for inputs with small absolute value.
	 */
